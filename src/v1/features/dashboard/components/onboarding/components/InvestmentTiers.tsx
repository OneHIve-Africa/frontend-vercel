...
import { investmentTiers } from "../data/data";
  ...
  return (
    <div className="w-full flex flex-col items-center px-2 sm:px-4">
      <div className="text-center mb-4 max-w-full sm:max-w-2xl">
        <h1 className="text-xl sm:text-2xl font-bold mb-2">Welcome to One Hive Africa!</h1>
        <p className="text-gray-600 text-sm sm:text-base">
          Your investment empowers local farmers, boosts honey production, and
          contributes to environmental conservation all while securing
          profitable returns.
        </p>
      </div>
