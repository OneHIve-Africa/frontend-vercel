          ...
          {isLoading
            ...
            : filteredData.map((item) => (
                ...
                >
                  ...
                  <TableCell className="text-start text-sm font-light text-oha_secondary">
                    Active
                  </TableCell>
                  
                  <TableCell className="text-start text-sm font-light flex gap-4 justify-end pr-6">
                    <div className="rounded-[4.5px] text-oha_secondary bg-green-100 font-semibold text-xs px-4 py-2">
                      Completed
                    </div>
                    <div className="rounded-[4.5px] text-[#404040] bg-[#4040403f] font-semibold text-xs px-4 py-2">
                      Restrict
                    </div>
                    <div className="rounded-[4.5px] text-oha_primary bg-[#ff80093d] font-semibold text-xs px-4 py-2">
                      Remove
                    </div>
                  </TableCell>
                </TableRow>
